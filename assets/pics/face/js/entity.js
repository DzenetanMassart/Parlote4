document.getElementById("parlote_character").innerHTML = '<img class="chara" src="' + frame[0].image + '"/>';
    ...
    .then(function(stream) {
        ...
        javascriptNodeFRAME.onaudioprocess = function() {
            ...
            if (averageFRAME < 20) {
                ...
                document.getElementById("parlote_character").innerHTML = '<img class="chara" src="' + frame[1].image + '"/>';
            } else if (averageFRAME > 40 && averageFRAME < 60) {
                document.getElementById("parlote_character").innerHTML = '<img class="chara" src="' + frame[2].image + '"/>';
            } else if (averageFRAME > 60 && averageFRAME < 80) {
                document.getElementById("parlote_character").innerHTML = '<img class="chara" src="' + frame[3].image + '"/>';
            } else if (averageFRAME > 80 && averageFRAME < 100) {
                document.getElementById("parlote_character").innerHTML = '<img class="chara" src="' + frame[4].image + '"/>';
            } else {
                document.getElementById("parlote_character").innerHTML = '<img class="chara" src="' + frame[5].image + '"/>';
            }
